import{l as o}from"./index.msLzbWef.js";import{k as l,r as i,h as n,o as c,c as d}from"./entry.RTXGjyIc.js";const m={__name:"MixedYaxis",props:["dark","title","height"],setup(s){const t=s,r=l(()=>{const e=t.height??"256px";return parseInt(e)-68+"px"}),a=i(null);return n(()=>{o(["https://miniwidget.com/modules/chart-mixed.js"],"module",e=>{e.length===0&&(a.value.innerHTML=`
      <chart-bar 
			dark='${!!t.dark}'
			horizontal='false'
			stacked='true'
