import{u}from"./DgP4j9Ly.js";import{u as m}from"./CB9MmmUK.js";import{D as b,c as g}from"./BnV61cnB.js";import{bP as f,bt as x,bs as w,bq as v}from"./C-QD9eoP.js";import"./BfGWD8rQ.js";import"./Br4V6czL.js";import"./6bUBh_yt.js";import"./BLVB0qGI.js";import"./DdDBkiWh.js";import"./luMtsSGn.js";const k={name:"FinscChart",data(){return{customCSS:`
      ...
      `,tvWidget:null,datafeed:null}},methods:{getParameterByName(t){t=t.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");const s=new RegExp("[\\?&]"+t+"=([^&#]*)").exec(window.location.search);return s===null?"":decodeURIComponent(s[1].replace(/\+/g," "))},finscChart(t){var c;const e="https://app.finsc.vn/api/v1";this.datafeed=new b(e,5e3,{maxResponseLength:1e3,expectedOrder:"latestFirst"});const s=new Blob([this.customCSS],{type:"text/css"}),i=URL.createObjectURL(s),o=localStorage.getItem("tradingview.current_theme.name")!=="light",n=this.getParameterByName("theme")||(o?"dark":"light");this.tvWidget=window.tvWidget=new TradingView.widget({theme:n,load_last_chart:!0,autosize:!1,width:"100%",height:"100%",symbol:this.symbol,interval:"1D",timezone:"Asia/Bangkok",container:t,datafeed:this.datafeed,library_path:"/static/tv/charting_library/",locale:this.getParameterByName("lang")||"en",custom_css_url:i,enabled_features:["study_templates"],charts_storage_url:e,client_id:this.userId,user_id:this.userId,auto_save_delay:10,charts_storage_api_version:"1.1",disabled_features:["popup_hints"]}),this.tvWidget.headerReady().then(()=>{const a=this.tvWidget.createButton({useTradingViewStyle:!1,align:"right"});a.dataset.internalAllowKeyboardNavigation="true",a.id="theme-toggle",a.innerHTML=`<label for="theme-switch" id="theme-switch-label">Dark Mode</label>
        <div class="switcher">
