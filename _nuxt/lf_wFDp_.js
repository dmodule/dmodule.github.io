import{g as E,n as O,o as u,d as P,s as B,b as T,c as U}from"./DJrEdPx_.js";import{c as k}from"./DufZqOZ-.js";import{a_ as x,bb as H,b3 as N,ba as w,bU as C}from"./B5CNXMPg.js";import"./p-mXrVAG.js";import"./BLVB0qGI.js";import"./DdDBkiWh.js";const Q={__name:"OrderCase",props:{dataSI:{type:Object,default:()=>({})},dataTP:{type:Object,default:()=>({})}},setup(b){const v=b,p=x(()=>E()),{emit:s,on:g,off:S}=k();let t=null,m=null,a=null,r=null,l=null;H(()=>{if(t=document.querySelector(".ordercase-cover"),t){o();return}f(),q(),O(t),o(),h()});const f=()=>{t=document.createElement("div"),t.classList.add("ordercase-cover"),t.innerHTML=`
      <div class="ordercase">
